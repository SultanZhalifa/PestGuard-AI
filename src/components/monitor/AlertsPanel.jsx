...
export default function AlertsPanel({ logs, t }) {
  ...
  const filterButtons = [
    ...
    { key: 'info',    label: t.liveMonitor.info,     color: '#57534e' },
  ];
    ...
    >
      ...
      >
        {filteredLogs.map((log) => {
          const riskColor = RISK_COLORS[log.risk] || '#57534e';
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: '0.7rem', color: 'var(--text-secondary)' }}>
                  ...
                  {(() => {
                    ...
                    const latColor = lat < 1000 ? '#292524' : lat < 3000 ? '#b45309' : '#b91c1c';
                    return (
                      <span style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4, flexShrink: 0 }}>
                ...
                <div style={{ display: 'flex', gap: 4 }}>
                  ...
                  <button
                    ...
                    style={shareBtn('#44403c')}
                    onMouseOver={e => Object.assign(e.currentTarget.style, shareBtnHover('#44403c'))}
                    onMouseOut={e => Object.assign(e.currentTarget.style, shareBtn('#44403c'))}
                  >
        ...
        {filteredLogs.length === 0 && (
          ...
          >
            ...
            {dismissed.size > 0
              ? t.liveMonitor.alertsCleared
              : (alertFilter === 'all' ? t.liveMonitor.noRecentAlerts : t.liveMonitor.noFilteredAlerts.replace('{risk}', alertFilter))}
          </div>
        )}
      </div>
