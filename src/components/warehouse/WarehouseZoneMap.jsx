    ...
    <div className="card" style={{ padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', fontSize: '0.7rem', fontWeight: '600' }}>
          ...
          <span style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', color: '#b91c1c' }}>
            <span style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#b91c1c' }}></span> HIGH ALERT
          </span>
        </div>
      </div>
                ...
                >
                  ...
                  {intensity > 70 && (
                    <circle cx={zone.x + zone.w / 2} cy={zone.y + zone.h / 2} r="6" 
                      fill="none" stroke="#b91c1c" strokeWidth="0.3" opacity="0.5">
