...
const ARCH_ITEMS = [
  { name: 'Camera / Simulator', sub: 'OpenCV + CLAHE', color: '#44403c', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z' },
  { name: 'Zone Workers', sub: 'Multi-thread', color: '#57534e', icon: 'M4 6h16M4 12h16M4 18h16' },
  ...
  { name: 'FastAPI', sub: 'Backend API', color: '#292524', icon: 'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01' },
  { name: 'SQLite', sub: 'Logs + RBAC', color: '#57534e', icon: 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4' },
  { name: 'Alerts', sub: 'WS + Telegram', color: '#78716c', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
